...
public class BigDataUtilities {
     ...
     * @return
     */
    public static Properties setUpBasicProperties(String journalFileName) {
    ...
    public static Repository instantiateJournalFromRdFfile(
    		String journalName, 
    		String resource, 
    		String baseURL) throws Exception {
    	
		Properties properties = BigDataUtilities.setUpBasicProperties("kefed");
        ...
        BigDataUtilities.loadDataFromDocument(repo, resource, baseURL);
    ...
    public static void loadDataFromDocument(Repository repo, String resource, 
            String baseURL) throws Exception {
